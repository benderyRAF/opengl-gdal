...
class Layer(MajorObject):
    ...
    def Rename(self, *args):
        """Rename(self, char new_name) -> OGRErr"""
...
class Geometry(_object):
    ...
    def ExportToWkb(self, *args, **kwargs):
        """
        ExportToWkb(self, OGRwkbByteOrder byte_order = wkbNDR) -> OGRErr
    ...
    def ExportToIsoWkb(self, *args, **kwargs):
        """
        ExportToIsoWkb(self, OGRwkbByteOrder byte_order = wkbNDR) -> OGRErr
    ...
    def MakeValid(self, *args):
        """
        MakeValid(self, char options = None) -> Geometry
